        ...
        <tbody>
            ...
            <tr>
				...
				<td>
					...
					<button type="button" id="eliminar" name="eliminar" class="btn btn-danger borrar" objeto="{{ $constancia->id }}"  onclick="return confirmSubmit(document.forms['form-eliminar-constancia'], '¿Está realmente seguro de eliminar este registro?');"><i class="icon-trash position-right"></i> Eliminar</button>
				</td>
			</tr>
        </tbody>
    </table>
