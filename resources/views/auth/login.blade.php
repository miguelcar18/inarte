...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Inicio de sesión - Inarte</title>
									...
									<div id="login-box" class="login-box visible widget-box no-border">
										<div class="widget-body">
											<div class="widget-main">
												...
												{!! Form::open(['route' => 'login', 'method' => 'post', 'id' => 'formLogin', 'name' => 'formLogin', 'class' => 'form-validate', 'novalidate' => 'novalidate']) !!}
													<fieldset>
														<label>
											...
											<div class="toolbar clearfix">
												<div class="text-center">
													<a href="{{ URL::route('password.request') }}" class="forgot-password-link">
