...
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>Restaurar contraseña - Inarte</title>
									...
									<div id="login-box" class="login-box visible widget-box no-border">
										<div class="widget-body">
											<div class="widget-main">
												...
												@endif
												{!! Form::open(['route' => 'password.email', 'method' => 'post', 'id' => 'formEmailPassword', 'name' => 'formEmailPassword', 'class' => 'form-validate', 'novalidate' => 'novalidate']) !!}
													<fieldset>
														<label>
															<span class="block input-icon input-icon-right">
																{!! Form::email('email', null, ['placeholder' => 'Email', 'class' => 'span12', 'id' => 'email', 'required' => true, 'value' => old('email')]) !!}
														...
														<div class="space"></div>
														<div class="clearfix">
															{!! Form::button('<i class="icon-envelope"></i> Enviar correo', ['class'=> 'pull-right btn btn-small btn-primary', 'id' => 'EmailPasswordButton', 'type' => 'submit']) !!}
														</div>
