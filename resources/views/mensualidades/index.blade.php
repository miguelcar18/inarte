...
@section('titulo')
<title>Mensualidades - Inarte</title>
@stop

@section('cabecera')
@include('layouts.breadcrumb', ['titulo' => "Mensualidades", 'tituloModulo' => "Mensualidades"])
@stop
...
<div class="row-fluid">
	<h3 class="header smaller lighter blue">Listado de mensualidades</h3>
	...
	{!! Form::open(array('route' => array('mensualidades.destroy', 'USER_ID'), 'method' => 'DELETE', 'role' => 'form', 'id' => 'form-delete')) !!}
        {!! Form::close() !!}
</div>
