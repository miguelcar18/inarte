        ...
        <tbody>
            ...
            <tr>
				...
				<td>
					...
					<button type="button" id="eliminar" name="eliminar" class="btn btn-danger borrar" objeto="{{ $mensualidad->id }}"  onclick="return confirmSubmit(document.forms['form-eliminar-mensualidad'], '¿Está realmente seguro de eliminar este registro?');"><i class="icon-trash position-right"></i> Eliminar</button>
				</td>
			</tr>
        </tbody>
    </table>
